...
CREATE TABLE EXAMCATEGORY(
	...
	exam_year DATE, -- INDICATES THE TIME OF THE EXAM 
...
CREATE TABLE COURSEWORK(
	...
	Cwrok_subject_level VARCHAR(10), --THIS INDICATE IF PRACTICAL IS FOR WASSCE OR GABECE
	Cwork_name VARCHAR(20),
	courseword_rate DECIMAL(8,2),
	remarks VARCHAR(500),
	CONSTRAINT coursework_pk PRIMARY KEY(subject_id),
	CONSTRAINT coursework_subject_fk FOREIGN KEY(subject_id, Cwrok_subject_level) REFERENCES SUBJECT(subject_code, exam_category_code),
	CONSTRAINT courseWork_SubjectLevel_fk FOREIGN KEY(Cwrok_subject_level) REFERENCES EXAMCATEGORY(exam_category_code),
);

CREATE TABLE PRACTICAL(
	subject_id VARCHAR(10),
	practicalSubLevel VARCHAR(10), --THIS INDICATE IF PRACTICAL IS FOR WASSCE OR GABECE
	practical_name VARCHAR(20),
	practical_rate DECIMAL(8,2),
	remarks VARCHAR(500),
	CONSTRAINT practical_work_pk PRIMARY KEY(subject_id),
	CONSTRAINT practical_work_subject_fk FOREIGN KEY(subject_id, practicalSubLevel) REFERENCES SUBJECT(subject_code, exam_category_code)
);
...
CREATE TABLE SCRIPTALLOCATION( -- SCRIPT ALLOCATION 
...
CREATE TABLE MEETINGATTENDANCE( --7351999 Damit
	meeting_code INTEGER,	
...
CREATE TABLE INVIGILATION(
	...
	endDate DATE,
	amountEarned DECIMAL(8,2),
	CONSTRAINT contractor_invigilation_fk FOREIGN KEY(examiner_code) REFERENCES CONTRACTOR(contractor_code),
